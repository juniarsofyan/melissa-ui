...
(function ($) {
    'use strict';
    var TURAN_JS = {
        init: function () { // this.turan_product_quantity_hanlde();
        ...
        turan_masonry: function () {
            var masonry = $('.masonry-grid').isotope({ // set itemSelector so .grid-sizer is not used in layout
                itemSelector: '.grid-item',
                percentPosition: true,
                layoutMode: 'masonry',
                masonry: { // set to the element
        ...
        turan_dropdown: function () {
            ...
            $(document).on('click', function (event) {
                ...
                if (_target.length > 0) {
                    ...
                    if ($(event.target).is('[data-turan="turan-dropdown"]') || $(event.target).closest('[data-turan="turan-dropdown"]').length > 0) {
        ...
        turan_product_thumbnail_carousel: function () { // owl config
        ...
        turan_countdown: function () {
            if ($('.turan-countdown').length > 0) {
                ...
                $('.turan-countdown').not('.not-run').each(function () {
                    ...
                    _this.countdown({until: austDay, labels: labels, layout: layout});
                });
            }
        },
        ...
        turan_general_functions: function () { // click menu
        ...
        turan_product_variation_handle: function () { // size attribute handle
                ...
                $(document).on('click', '.product-type-variable .product-thumb .color-chosen .color-change', function (event) {
                    ...
                    if (typeof requite !== 'undefined' && requite.length) {
                        for (var i = 0; i < requite.length; i++) {
                            ...
                            if (typeof acept_list !== 'object' || typeof items == 'undefined') 
                                continue;
